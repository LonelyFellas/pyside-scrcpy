...
class PaginationWidget(QWidget):
    def __init__(self, application_path='', quantity=0):
        super().__init__()
        ...
        prev_button.setIcon(QIcon(os.path.join(application_path, 'images', 'prev_page.png')))
        prev_button.setObjectName("outline_btn_none")
        prev_button.setIconSize(QSize(24, 24))
        view_cursor(prev_button)
        next_button = QPushButton()
        next_button.setIcon(QIcon(os.path.join(application_path, 'images', 'next_page.png')))
