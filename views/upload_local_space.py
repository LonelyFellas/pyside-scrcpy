...
from PySide6.QtCore import Slot, QThread, Signal, QTimer, QRect, QSize
from PySide6.QtGui import Qt, QIcon
from PySide6.QtWidgets import QFrame, QSpacerItem, QSizePolicy, QVBoxLayout, QLabel, QListWidgetItem, QPushButton, \
    QFileDialog, QListWidget, QHBoxLayout

from adb import AdbPushThread
from global_state import GlobalState
from views import handle_startupinfo
from views.config import EXPEND_WIDTH, UPLOAD_WIDTH
...
class UploadLocalSpace(QFrame):
    def __init__(self, height=590):
        super().__init__()
